...
import voleyball from '../../../public/voleyball.png';
        ...
        {buttons.map((button) => (
          <button
            ...
            onClick={() => {
              const ballConfigs = {
                Nobg: ["white", "", "100%"],
                basketball: ["white", basketball, "115%"],
                football: ["white", football, "105%"],
                voleyball: ["white", voleyball, "108%"],
                human: ["white", human, "105%"],
                cartoon: ["white", cartoon, "105%"],
                logo: ["white", logo, "100%"]
              };
